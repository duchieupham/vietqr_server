...
public interface TerminalBankReceiveRepository extends JpaRepository<TerminalBankReceiveEntity, Long> {
    ...
    @Query(value = "SELECT a.id AS terminalBankReceiveId, "
            + "a.terminal_id AS terminal_id, b.code AS terminalCode, "
            ...
            + "WHERE raw_terminal_code = :rawCode AND c.bank_account = :bankAccount "
