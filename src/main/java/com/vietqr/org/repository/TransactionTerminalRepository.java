...
@Repository
public interface TransactionTerminalRepository extends JpaRepository<TransactionTerminalEntity, Long> {
    ...
    List<TransactionTerminalEntity> findAllByTerminalCodeAndTimeBetween(String terminalCode, long fromTime, long toTime);
