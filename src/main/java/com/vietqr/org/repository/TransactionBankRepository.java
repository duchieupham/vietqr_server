...
public interface TransactionBankRepository extends JpaRepository<TransactionBankEntity, Long>{
	...
	int insertTransactionBank(@Param(value = "transactionid") String transactionid,@Param(value = "transactiontime") long transactiontime, @Param(value = "referencenumber") String referencenumber,  @Param(value = "amount") int amount,  @Param(value = "content") String content, @Param(value = "bankaccount") String bankaccount, @Param(value = "transType") String transType, @Param(value = "reciprocalAccount") String reciprocalAccount,@Param(value = "reciprocalBankCode") String reciprocalBankCode,@Param(value = "va") String va,@Param(value = "valueDate") long valueDate,@Param(value = "id") String id);
