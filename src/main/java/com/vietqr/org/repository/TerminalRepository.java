...
//            + "LIMIT :offset, 20"
    ...
    @Query(value = "SELECT raw_terminal_code FROM terminal WHERE raw_terminal_code = :terminalCode LIMIT 1", nativeQuery = true)
    ...
    @Query(value = "SELECT a.* FROM terminal a "
            ...
            + "WHERE b.terminal_code = :terminalCode LIMIT 1", nativeQuery = true)
    ...
    List<TerminalCodeResponseDTO> getListTerminalResponseByBankIdAndMerchantId(String merchantId, String bankId);
    ...
    @Query(value = "SELECT a.code "
            ...
            + "SELECT a.code FROM terminal a "
            + "INNER JOIN terminal_bank_receive b ON a.id = b.terminal_id "
            + "WHERE a.name LIKE %:terminalName% AND b.bank_id IN (:bankIds) "
            + ") ", nativeQuery = true)
    List<String> getAllCodeByNameAndBankId(String terminalName, List<String> bankIds);
