...
public class DateTimeUtil {
    ...
    public static long get2DaysAgo() {
        LocalDateTime localDateTime = LocalDateTime.now().minusDays(2).with(LocalTime.MIN);
        return localDateTime.toEpochSecond(ZoneOffset.UTC);
    }

    public static long getDaysAgo(int days) {
        LocalDateTime localDateTime = LocalDateTime.now().minusDays(days).with(LocalTime.MIN);
        return localDateTime.toEpochSecond(ZoneOffset.UTC);
    }
}
