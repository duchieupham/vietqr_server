...
public class MBTokenUtil {
    private static final Logger logger = Logger.getLogger(MBTokenUtil.class);

    public static TokenProductBankDTO getMBBankToken() {
    ...
    //
    public static TokenProductBankDTO getMBnkMMSToken() {
        TokenProductBankDTO result = null;
        try {
