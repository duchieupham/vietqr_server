...
public class BankTypeController {
	...
	public ResponseEntity<ResponseMessageDTO> insertBankType(@Valid @RequestParam String bankCode, @Valid @RequestParam String bankName, @Valid @RequestParam MultipartFile imgUrl){
