...
@Entity
@Table(name = "Lark")
public class LarkEntity implements Serializable {
    /**
     *
     */
    ...
    public LarkEntity(String id, String name, String webhook, String userId, String notificationTypes, String notificationContents) {
        this.id = id;
        this.name = name;
