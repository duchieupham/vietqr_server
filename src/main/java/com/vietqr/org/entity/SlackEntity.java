...
@Entity
@Table(name = "Slack")
public class SlackEntity implements Serializable {
    /**
     *
     */
    ...
    public SlackEntity(String id, String name, String webhook, String userId, String notificationTypes, String notificationContents) {
        this.id = id;
        this.name = name;
