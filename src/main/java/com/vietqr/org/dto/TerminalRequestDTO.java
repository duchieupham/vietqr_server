...
public class TerminalRequestDTO {
    ...
    public TerminalRequestDTO(String terminalId, String terminalName, String terminalAddress, String provinceCode, String districtCode, String wardsCode, String mccCode, int fee, String bankCode, String bankCodeBranch, String bankAccountNumber, String bankAccountName, String bankCurrencyCode) {
