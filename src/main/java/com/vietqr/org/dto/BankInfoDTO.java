...
public class BankInfoDTO {
    ...
    public BankInfoDTO(String bankAccount, String bankAccountName, boolean status, boolean mmsActive, String phoneAuthenticated, String nationalId, String bankShortName, int fromDate, int toDate, int activeService) {
