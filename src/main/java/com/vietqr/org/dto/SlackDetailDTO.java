...
public class SlackDetailDTO implements Serializable {
    ...
    public SlackDetailDTO(String id, String name, String webhook, String userId, List<SlackBankDTO> banks, List<String> notificationTypes, List<String> notificationContents) {
        this.id = id;
        this.name = name;
