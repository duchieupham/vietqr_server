...
public class TransCLSftpDTO implements Serializable {
    /**
     *
     */
    ...
    public TransCLSftpDTO() {

    }

    public TransCLSftpDTO(String no, String channel, String channelName, String transType, String requestId,
            ...
            String bankAccount, String bankName, String napasKey, String status2, String addInfo, String checkSum) {
        this.no = no;
    ...
    public String toString() {
        return no + "|" + channel + "|" + channelName + "|" + transType + "|" + requestId + "|" + bankTransId + "|" + ft
                ...
                + bankName + "|" + napasKey + "|" + status2 + "|" + addInfo + "|" + checkSum;
    }
}
