...
//        return repo.getTerminalBankShareByUserId(userId, offset);
    ...
    @Override
    public int updateAccountBankArrangement(String bankId, int index, String userId) {
        return repo.updateAccountBankArrangement(bankId, index, userId);
    }

    @Override
    public List<String> getListBankIdSharedByUserId(String userId) {
        return repo.getListBankIdSharedByUserId(userId);
    }
